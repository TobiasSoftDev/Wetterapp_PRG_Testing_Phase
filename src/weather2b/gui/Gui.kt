...
// Damit die Auswahlliste nicht die gesamten Objekt-Informationen anzeigt, sondern einen bestimmten, von uns festgelegten String.
    ...
    private val hBoxDayViewFavorites by lazy {
        HBox().apply {
            ...
            //HBox.setHgrow(weather2b.gui.view.dayView.hBoxDayView, Priority.ALWAYS)
    ...
    override fun start(stage: Stage) {
        ...
        //weather2b.gui.view.dayView.getView().prefWidthProperty().bind(root.widthProperty().multiply(0.50))
