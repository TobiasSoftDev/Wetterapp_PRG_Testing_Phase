/*
  ...
  Beschreibung: In Day View wird das Feld unter der Suchleiste erstellt und mit den aktuellen Wetterdaten gefuellt.
 */
...
object dayView {
    ...
    val btnAddFavorite by lazy {
        favorites.createAddButton(
            activeLocation = { Gui.Companion.selectedLocation },
            activeWeather = { Gui.Companion.selectedLocationWeather }
        )
    }
